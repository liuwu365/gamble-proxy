...
//            stay.inputVal();
        ...
        startFun:function(){
            stay.start.datepicker({
                ...
                //appendText : '明天',
                firstDay : (new Date().getHours())<stay.tim?1:2,
                showOtherMonths:true,
                minDate :(new Date().getHours())<stay.tim?1:2,
                maxDate:(new Date().getHours())<stay.tim?1200:1200,
        ...
        endFun:function(){
            ...
            stay.end.datepicker({
                ...
                onSelect:function(){
                    ...
                    stay.end.datepicker('option', stay.compare($(this)));
                }
            });
        },
        ...
        inputVal:function(){
            stay.inputTimes(stay.start,(new Date().getHours())<16?1:2);
